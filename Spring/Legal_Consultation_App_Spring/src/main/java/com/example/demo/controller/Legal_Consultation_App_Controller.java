...
//	CLIENT CONTROLLER
	...
	public Client getClientByEmail(@PathVariable("email")String email) {
		return serviceImp.getClientByEmail(email);
	}
...
//	LAWYER CONTROLLER
	...
	@GetMapping("/lawyerbyemail/{email}")
	public Lawyer getLawyerByEmail(@PathVariable("email")String email) {
		return serviceImp.getLawyerByEmail(email);
	}
	
	@GetMapping("/lawyerbyname/{name}")
	public Lawyer getLawyerByName(@PathVariable("name")String name) {
		return serviceImp.getLawyerByName(name);
	}
